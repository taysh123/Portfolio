"""PREVIEW textures v4 — screens designed compositionally, every value from real repo output.
...
for i, name in enumerate(["typecheck", "lint", "build"]):
    y = 290 + i * 130
